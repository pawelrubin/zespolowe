# swagger-client
[math.js](math.js) is available as a RESTful API. Evaluations can be done via [GET](https://api.mathjs.org/#get) or [POST](https://api.mathjs.org/#post) requests. The duration per evaluation of this free service is limited to 10 seconds. 
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**root_get**](docs/DefaultApi.md#root_get) | **GET** / | Calculate given expression with GET
*DefaultApi* | [**root_post**](docs/DefaultApi.md#root_post) | **POST** / | Calculate given expression with POST
